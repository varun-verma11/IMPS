...
struct Table *initialiseOpcodeTable(void) {
  ...
  addToTable("div",19,table);
  addToTable("divi",20,table);
  addToTable("mod",21,table);
  addToTable("modi",22,table);
  addToTable("fact",23,table);
  addToTable("facti",24,table);
  addToTable("swap",25,table);
  return table;
}
